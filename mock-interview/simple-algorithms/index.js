...
function maxOfTwoNumbers(num1, num2) {
  ...
  // 1. compare num1 with num2
  // 2. return bigger numbers
  // 3. declare vlaues for parameter
  // 4. consol.log the function
...
// console.log(maxOfTwoNumbers(689, 189));
...
function findLongestWord(words) {
  ...
  // 1. declare variable for current word in the array
  // 2. go through all words in the array and compare length
  // 3. if current word is shorter than next word. next word will be current word
  // 4. return current word
  // 5. consol.log
...
function averageWordLength(words) {
  ...
  // 1. wir brauchen die anzahl der wörter
  // 2. brauchen wir die gesamte anzahl der buchstaben
  // 3. formel buchstaben/wörter
}
