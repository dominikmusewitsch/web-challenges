...
console.log("Aufgabe 2:", titlesWithDuration);

const timePerServing = recipes.map(
  (recipe) => recipe.duration / recipe.servings
); // [20, 10, 432, 12]
console.log("Aufgabe 3:", timePerServing);
...
console.log("Mehr als 2 Portionen:", allRecipesWithMoreThan2Servings);

const allRecipesWithTitlesLongerThan12Characters = recipes.filter(
  (recipe) => recipe.title.length > 12
);
console.log(
  "Nur Rezepte mit langem Titel:",
